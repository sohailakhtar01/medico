  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Health Centers", href: "/health-centers" }
      ]
    },
    {
      title: "Support",
        ...
        <div className="grid lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-bold">HealthConnect Pro</span>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Transforming healthcare accessibility across rural India through innovative telemedicine 
              and digital health record solutions. Making quality healthcare available to everyone, everywhere.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-300">support@healthconnectpro.com</span>
              </div>
              <div className="flex items-center">
                <Phone className="w-5 h-5 text-green-400 mr-3" />
                <span className="text-gray-300">+91 1800-123-HEALTH (432584)</span>
              </div>
              <div className="flex items-center">
        ...
        <div className="border-t border-gray-800 mt-12 pt-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex">
              ...
              />
              <button className="bg-green-600 hover:bg-green-700 px-6 py-3 rounded-r-lg font-medium transition-colors duration-200">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-gray-400">
              <p>&copy; 2025 HealthConnect Pro. All rights reserved.</p>
              <div className="flex space-x-4">
                <a href="/privacy" className="hover:text-green-400 transition-colors duration-200">Privacy Policy</a>
                <a href="/terms" className="hover:text-green-400 transition-colors duration-200">Terms of Service</a>
                <a href="/cookies" className="hover:text-green-400 transition-colors duration-200">Cookie Policy</a>
              </div>
            </div>
          </div>
        </div>
